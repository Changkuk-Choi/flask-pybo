...
def modify(answer_id):
    ...
    if request.method == "POST":
        ...
        if form.validate_on_submit():
            ...
            db.session.commit()
            return redirect(f"{url_for('question.detail', answer_id=answer_id)}#answer_{answer.id}")
    else:
